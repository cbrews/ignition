...
def test_certificate_parse():
  ...
  assert cert_wrapper.certificate.subject.rfc4514_string(
  ...
  assert (
    cert_wrapper.fingerprint() == 'ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAACAQDzR2vptlPcQUlDHLanY9RsSwLgFHT3ecCyUicbY4HBOvlqRRL9l' +
