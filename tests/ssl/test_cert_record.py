...
def test_from_string():
    cert_record = CertRecord.from_string(
...
def test_is_expired(datetime_mock):
    ...
    cert_record_not_expired = CertRecord(
        "myhostname.sample", "ssh-rsa fingerprint", test_datetime
    )
    cert_record_expired = CertRecord(
        "expired.sample", "ssh-rsa fingerprint", test_past_datetime
    )
